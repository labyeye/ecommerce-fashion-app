...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const baseClasses =
    "fixed inset-y-0 left-0 z-50 md:relative md:z-auto bg-primary-50 text-heading w-52 flex flex-col transform transition-transform duration-300";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-ds-700">
          ...
          <button
            ...
            className="w-full flex items-center px-3 py-2 text-sm text-heading hover:bg-primary-100 rounded-lg transition-colors"
          >
            <LogOut className="w-4 h-4 mr-2 text-primary-900" />
            Logout
          </button>
        </div>
      </div>
