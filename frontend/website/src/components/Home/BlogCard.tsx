  ...
  return (
    ...
    >
      <div className="relative h-48 overflow-hidden">
        ...
        {blog.isFeatured && (
          <div
            className="absolute top-3 right-3 text-white px-2 py-1 rounded-full text-xs font-semibold"
        ...
        <div
          className="absolute top-3 left-3 text-white px-2 py-1 rounded-full text-xs font-semibold"
      ...
      <div className="p-6">
        ...
        <div className="mt-4 pt-4 border-t border-gray-100">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="text-sm font-medium" style={{ color: "#95522C" }}>
