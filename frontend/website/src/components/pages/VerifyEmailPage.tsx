...
const VerifyEmailPage: React.FC = () => {
  ...
  const verifyEmail = async () => {
    try {
      const response = await fetch('https://ecommerce-fashion-app-som7.vercel.app/api/auth/verify-email', {
        method: 'POST',
        headers: {
  ...
  const handleResendVerification = async () => {
    ...
    try {
      const response = await fetch('https://ecommerce-fashion-app-som7.vercel.app/api/auth/resend-verification', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
