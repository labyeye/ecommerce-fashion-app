  ...
  return (
    <div className="min-h-screen pt-20 pb-16 bg-[#FFF2E1]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-20">
        <div className="bg-background rounded-lg shadow-lg p-6 sm:p-8 md:p-10 max-w-md sm:max-w-lg mx-auto mb-12">
          <span className="block text-2xl md:text-4xl font-semibold mb-4">Change Phone</span>
          {message && (
            <span className="block mb-4 text-sm md:text-base text-red-700">{message}</span>
          )}
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm md:text-2xl mb-1">New Phone</label>
              <input
                type="text"
                value={phone}
            ...
            <div>
              <label className="block text-sm md:text-2xl mb-1">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3">
              ...
              <button
                type="button"
                className="w-full sm:w-auto px-4 py-2 border rounded bg-background"
